...
st.set_page_config(page_title= "Phonepe Pulse Data Visualization",
                   ...
                   menu_items={'About': """# This dashboard app is created by `Tirumal`!
...
with st.sidebar:
    selected = option_menu(None, ["Home","Top Charts","Visualization"], 
                ...
                styles={"nav-link": {"font-size": "30px", "text-align": "centre", "margin": "-2px", "--hover-color": "#6F36AD"},
                         "icon": {"font-size": "30px"},
...
if selected == "Home":
    ...
    with col1:
        ...
        st.markdown("### :violet[Overview :] This visualization allows you to explore and analyze PhonePe's Pulse data from 2018 to 2022. With interactive charts and various metrics to choose, you can gain insights into PhonePe's business performance and growth over time.") 
    ...
    with col2:
        ...
        st.image("https://media.tenor.com/YZPnGuPeZv8AAAAd/coding.gif",width=450)
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\a-z\OneDrive\Desktop\PROJECT\phonepe\Statenames.csv')
            df1.State = df2
